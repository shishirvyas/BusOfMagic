...
export const adminApi = {
  getAll: async (): Promise<AdminUser[]> => {
    ...
    if (!response || !response.ok) throw new Error('Failed to fetch admins');
    return response.json();
  },
  ...
  getById: async (id: number): Promise<AdminUser> => {
    ...
    if (!response || !response.ok) throw new Error('Failed to fetch admin');
    return response.json();
  },
  ...
  update: async (id: number, data: CreateAdminRequest): Promise<AdminUser> => {
    ...
    if (!response || !response.ok) throw new Error('Failed to update admin');
    return response.json();
  },
  ...
  toggleStatus: async (id: number): Promise<void> => {
    ...
    if (!response || !response.ok) throw new Error('Failed to toggle admin status');
  },
  ...
  delete: async (id: number): Promise<void> => {
    ...
    if (!response || !response.ok) throw new Error('Failed to delete admin');
  },
};
...
export const roleApi = {
  getAll: async (): Promise<Role[]> => {
    ...
    if (!response || !response.ok) throw new Error('Failed to fetch roles');
    return response.json();
  },
  ...
  getById: async (id: number): Promise<Role> => {
    ...
    if (!response || !response.ok) throw new Error('Failed to fetch role');
    return response.json();
  },
  ...
  update: async (id: number, data: Partial<CreateRoleRequest>): Promise<Role> => {
    ...
    if (!response || !response.ok) throw new Error('Failed to update role');
    return response.json();
  },
  ...
  updatePermissions: async (id: number, permissionCodes: string[]): Promise<Role> => {
    ...
    if (!response || !response.ok) throw new Error('Failed to update role permissions');
    return response.json();
  },
  ...
  delete: async (id: number): Promise<void> => {
    ...
    if (!response || !response.ok) throw new Error('Failed to delete role');
  },
  ...
  toggleStatus: async (id: number): Promise<void> => {
    ...
    if (!response || !response.ok) throw new Error('Failed to toggle role status');
  },
};
...
export const permissionApi = {
  getAll: async (): Promise<Permission[]> => {
    ...
    if (!response || !response.ok) throw new Error('Failed to fetch permissions');
    return response.json();
  },
...
export const menuApi = {
  getMenuForUser: async (): Promise<MenuItem[]> => {
    ...
    if (!response || !response.ok) throw new Error('Failed to fetch menu');
    return response.json();
  },
  ...
  getGroupedMenu: async (): Promise<MenuGroup[]> => {
    ...
    if (!response || !response.ok) throw new Error('Failed to fetch grouped menu');
    return response.json();
  },
  ...
  getAllMenuItems: async (): Promise<MenuItem[]> => {
    ...
    if (!response || !response.ok) throw new Error('Failed to fetch menu items');
    return response.json();
  },
  ...
  getAllMenuGroups: async (): Promise<MenuGroup[]> => {
    ...
    if (!response || !response.ok) throw new Error('Failed to fetch menu groups');
    return response.json();
  },
};
